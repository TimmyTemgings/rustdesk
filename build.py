...
def build_flutter_dmg(version, features):
    if not skip_cargo:
        ...
        system2(
            f'MACOSX_DEPLOYMENT_TARGET=14.0 RUSTFLAGS="-lframework=CoreServices -lframework=CoreFoundation -lframework=AudioUnit -lframework=AudioToolbox -lframework=CoreAudio -L/opt/homebrew/Cellar/ffmpeg/7.1_3/lib -lswresample" cargo build --verbose --features {features} --lib --release')
    # copy dylib
    system2(
